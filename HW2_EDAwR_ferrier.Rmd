...
```{r problem2}
ggplot(county_df, aes(Income)) + geom_density() + geom_histogram(color = 'red')
```

###This data is asymmetrical with a mode appearing around 40,000.  Since the right tail is much longer than the left tail, this data would be considered right-skewed.
