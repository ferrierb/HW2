...
GitHub URL: https://github.com/ferrierb/HW2
...
```
###It is pretty clear that the median income of counties in the Lower Peninsula is higher than the median income of counties in the Upper peninsula.
...
```
###The Midwest, Northeast, and West all look to have the majority of their poverty rates under 20% while the South looks like the mode of poverty rate is right around 20%.
